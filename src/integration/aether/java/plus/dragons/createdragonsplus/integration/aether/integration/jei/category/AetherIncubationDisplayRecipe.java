...
public class AetherIncubationDisplayRecipe implements net.minecraft.world.item.crafting.Recipe<Container> {
    ...
    public ItemStack getDisplayOutput() {
        ...
        stack.setHoverName(recipe.getEntity().getDescription());
        return stack;
    }

    public Component getMoaType() {
        var tag = recipe.getTag();
