...
public class AetherFanIncubationCategory extends ProcessingViaFanCategory<AetherIncubationDisplayRecipe> {
    public static final RecipeType<AetherIncubationDisplayRecipe> TYPE = new RecipeType<>(
            CDPCommon.asResource("aether_fan_incubation"), AetherIncubationDisplayRecipe.class);
    ...
    private static List<AetherIncubationDisplayRecipe> getAllRecipes() {
        var manager = CDPJeiPlugin.getRecipeManager();
        var recipes = new ArrayList<AetherIncubationDisplayRecipe>();
        manager.getAllRecipesFor(AetherRecipeTypes.INCUBATION.get()).forEach(recipe -> recipes.add(new AetherIncubationDisplayRecipe(recipe)));
        return recipes;
    }
}
