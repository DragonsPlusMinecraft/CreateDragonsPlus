...
public class DragonBreathMobJarFluidHandler implements IFluidHandler {
    ...
    public FluidStack getFluidInTank(int tank) {
        ...
        return amount == 0 ? FluidStack.EMPTY : new FluidStack(CDPFluids.DRAGON_BREATH.getSource(), amount);
    }
    ...
    public FluidStack drain(int maxDrain, FluidAction action) {
        ...
        return new FluidStack(CDPFluids.DRAGON_BREATH.getSource(), drained);
    }
